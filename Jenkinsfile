      ...
      stage('Test') {
        ...
        stage('Build') {
            steps {
                ...
                sh "docker build --tag utopia-flight-plane:$COMMIT_HASH ."
                sh "docker tag utopia-flight-plane:$COMMIT_HASH 038778514259.dkr.ecr.us-east-1.amazonaws.com/utopia-flight-plane:$COMMIT_HASH"
